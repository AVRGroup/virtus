     ...
     <tr>
       ...
       <td>
         ...
         <p style="line-height: 1em;font-size: 1em;">
           <a href="${lattesUrl}" target="_blank"><img width="30px" src="./img/logoLattes.jpeg" alt="lattes"></a>
           <a href="${linkedinUrl}" target="_blank"><img width="30px" src="./img/logoLinkedin.jpeg" alt="linkedin"></a>
         </p>
       </td>
     </tr>
   `;
